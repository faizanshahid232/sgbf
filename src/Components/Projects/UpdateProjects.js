...
import { editProjects } from '../../Redux/Slice/projects';
...
const UpdateProjects = () => {
  ...
  const [articalValues, setArticalValues] = useState({
    ...
    certificationLevel: state.item.certificationLevel,
    ratingSystem: state.item.ratingSystem,
    projectAreaSquareMeters: state.item.projectAreaSquareMeters,
    dateCertified: state.item.dateCertified,
    registerationDate: state.item.registerationDate,
    GrossSqFoot: state.item.GrossSqFoot,
    IsCertified: state.item.IsCertified,
  ...
  const [featureImage, setfeatureImage] = useState(state.item.featureImage);
