...
import { editInvoice } from '../../Redux/Slice/invoice';
...
const UpdateInvoice = () => {
  ...
  const [articalValues, setArticalValues] = useState({
    ...
    relatedUser: state.item.relatedUser,
    fullName: state.item.fullName,
    paymentMode: state.item.paymentMode,
    emailAddress: state.item.emailAddress,
    invoiceDescription: state.item.invoiceDescription,
    cardString: state.item.cardString,
    relatedNode: state.item.relatedNode,
    invoiceID: state.item.invoiceID,
    stripeToken: state.item.stripeToken,
    invoiceAmount: state.item.invoiceAmount,
    stripeResponse: state.item.stripeResponse,
    checkNumber: state.item.checkNumber,
    invoiceDate: state.item.invoiceDate,
    invoiceStatus: state.item.invoiceStatus,
    paymentDate: state.item.paymentDate,
  });
