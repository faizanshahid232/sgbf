...
const MemberShipPage = () => {
    ...
    return (
        <div>
            <Grid container data-aos="fade-in" sx={{ justifyContent: 'center', textAlign: 'center' }} p={2} id="member-images">
            ...
            <Grid container sx={{ justifyContent: 'center' }} spacing={4} p={2} data-aos="fade-in">
                <Grid item xs={12} sm={5} mx={2}>
                    <Typography className="offset-3" sx={{ fontWeight: "bold;", marginBottom: "20px;", fontSize: {sm:"2em;",lg:"3em;"}, lineHeight: "1.25;", fontFamily: 'jaf-bernina-sans' }}>Individual</Typography>
                    ...
                    <Button className="membership-btn" onClick={()=>{
                            navigate("/sign_in");
                    }}>Become an Individual Member.</Button>
                    {/* <Link to={'/sign_in'} className="membership-btn"
                    >Become an Individual Member.</Link> */}
                </Grid>
                <Grid item xs={12} sm={5} mx={2} py={2}>
                    <Typography className="offset-3" sx={{ fontWeight: "bold;", marginBottom: "20px;", fontSize: {sm:"2em;",lg:"3em;"}, lineHeight: "1.25;", fontFamily: 'jaf-bernina-sans' }}>Establishment</Typography>
                    ...
                    }}>Become an Establishment Member</Button>
                    {/* {!localStorage.getItem("sgbf_token") ?
                        <Link to={'/sign_in'} className="membership-btn"
                        >Become an Establishment Member</Link> : <Link to={'/dashboard/organization'} className="membership-btn"
